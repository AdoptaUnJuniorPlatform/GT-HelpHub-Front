    ...
    <>
      ...
      <AuthLayout>
        ...
        <div className="flex flex-col w-full h-full items-center">
          ...
          <span className="absolute text-right text-xl text-celeste-100 font-medium leading normal tracking-wide w-48 right-[7%] top-[12%]">Comparte conocimientos </span>
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            width="82" 
            height="84" 
            viewBox="0 0 82 84" 
            fill="none"
            className="absolute right-[14rem] top-[8rem]"
          >

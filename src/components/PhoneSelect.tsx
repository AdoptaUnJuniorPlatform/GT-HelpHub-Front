...
function PhoneSelect( {type, placeholder, value, onChange, name, className}: Input ) {
  return (
    <div className="flex flex-col w-full font-normal not-italic font-poppins">
      <div className={`flex flex-wrap items-center py-3 pd-4 pl-1 relative w-full bg-neutral-gray text-slate-700 text-sm/[18px] font-medium focus-within:ring-1 rounded-lg p-3 h-auto gap-[10px] border-[1px] transition-all ${className}}`}>
        
        <div className="flex items-center gap-1 border-r border-gray-300 pr-2 text-blue-gray-500">

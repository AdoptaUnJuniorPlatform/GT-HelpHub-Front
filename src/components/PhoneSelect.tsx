...
function PhoneSelect( {type, placeholder, value, onChange, name, className}: Input ) {
  return (
    <div className="flex flex-col w-full font-normal not-italic font-poppins">
      <div className={`flex flex-wrap items-center py-3 pd-4 pl-1 relative w-full text-slate-700 text-sm/[17.5px] focus-within:ring-1 rounded-lg p-3 h-auto gap-[10px] border-[1px] transition-all ${className}}`}>

...
function Edit() {
  return (
    <button className="flex justify-center items-center w-[6rem] h-[3.5rem] rounded-md gap-2 bg-[#1945E3] transition-transform transform active:scale-90 hover:bg-[#1945e3ea]">

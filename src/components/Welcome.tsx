...
function Welcome() {
  return (
    <aside className="flex justify-center items-center w-full lg:w-[650px] lg:h-[90vh] sm:h-[95vh] bg-violeta-100 flex-shrink-0 text-white p-4 lg:p-0 
  rounded-b-[40px] lg:rounded-l-[40px] lg:rounded-b-none">
      <section className="flex flex-col justify-between items-center lg:items-start w-full lg:w-[70%] h-full lg:h-[65%] lg:ml-28 lg:-mt-8">
        ...
        <div className="flex flex-col text-center lg:text-left mt-6 lg:mt-0">
          ...
          <h2 className="text-xl lg:text-2xl leading-normal font-normal">Comparte, aprende, crece</h2>
        </div>
        ...
        <div className="flex flex-col lg:flex-row w-full mt-6 lg:-mt-6 justify-center lg:justify-start items-center lg:items-start font-normal">

    ...
    >
      ...
      <label htmlFor={name} className="w-full">
        <input
          ...
          style={style}
          className={`text-slate-700 w-full text-sm md:text-base rounded-lg p-3 h-10 border border-blue-gray-100 mt-1.5 caret-violet-700 outline-violeta-100 outline-1 transition-all duration-300 focus:border-violet-500 bg-neutral-gray ${className}`}
        />
      </label>
    </section>
  )

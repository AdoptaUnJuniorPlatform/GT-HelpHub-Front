  ...
  return (
    <main className="flex justify-center items-center w-screen min-h-screen font-roboto not-italic px-4 md:px-12 lg:px-16 gap-8 md:gap-16">
      <section className="flex flex-col items-center lg:flex-row h-full w-full max-w-[650px]">
        <aside className="relative flex flex-col justify-center items-center w-full h-[80vh] lg:h-[90dvh] bg-violeta-20 flex-shrink-0 text-neutral-black p-2 sm:p-4 md:p-6 lg:p-8
